        ...
        <div id="content" className="col-start-2 col-end-12 col-start-2 col-end-12 md:col-start-5 md:col-end-13">
          <section id="info" className="relative z-6">
            <div className="border border-neutral-100 bg-white shadow-custom rounded-full w-fit flex items-center px-2 gap-2">
              ...
              <span className="text-neutral-600">{INTRO.status}</span>
            </div>
            <h1 className="heading text-gray-900 mt-2 md:mt-2 text-4xl md:text-7xl w-full md:w-3/4 pb-3 font-medium bg-gradient-to-r from-neutral-500 via-neutral-600 to-neutral-700 inline-block text-transparent bg-clip-text">
              {INTRO.heading}
            </h1>
          </section>
          <About />
          ...
          <footer className="content-section">
            ...
            <div className="flex items-center gap-2 md:gap-12 mt-5 w-1/2 flex-wrap">
              {FOOTER.links.map((link, idx: number) => (
                <div key={idx}>
